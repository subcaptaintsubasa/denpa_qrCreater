...
-   連絡先：Xアカウント（副キャプテン翼 [@subcaptain_yfm](https://x.com/subcaptain_yfm) ）（鍵垢になってる場合もあります。その場合はフォローリクエストして下さい。）、Git HubのIssue、またはDisscord（副キャプテン翼[@fukuyakaputenyoku](discordapp.com/users/1109485950008045579) ）
